...
**[Simple array language](./examples/array-language.md)**: A one-dimensional array language using a lexer with an explicit source lifetime, so that the tokens created outlive the source, despite storing borrows.
